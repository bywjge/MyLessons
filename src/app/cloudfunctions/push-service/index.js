...
function getGroupQRCode() {
  const words = [
    "【添加官方交流群】\n\n",
    `点击链接添加👉 <a href="https://meetinaxd.ltiex.com/static/group.jpg">获取群聊二维码</a>\n\n`,
...
function moreFunctionEcho() {
  const words = [
    ...
    `\n✨ 有更好的建议？点击添加<a href="weixin://bizmsgmenu?msgmenuid=1&msgmenucontent=获取群聊二维码">👉My Lesson 官方交流群👈</a>吧\n\n`,
  ]
